...
<%
	...
	double price=Double.parseDouble(request.getParameter("prices"));
	...
	try 
	{
		PreparedStatement ps=conn.prepareStatement("INSERT INTO orders (email, productId, quantity, price, totalprice, fname, lname, phno, address, country, state, pincode, payment) values (?,?,?,?,?,?,?,?,?,?,?,?,?) ");
		ps.setString(1,emailss);
		ps.setString(2,pid);
